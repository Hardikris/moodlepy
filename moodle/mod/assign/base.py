...
class BaseAssign(BaseMoodle):
    ...
    def lock_submissions(self, assignmentid: int, userids: List[int]) -> List[Warning]:
        res = self.moodle.post(
    ...
    def revert_submissions_to_draft(
    ...
    def save_grades(
        self, assignmentid: int, applytoall: int, grades: List[Grades.Create]
    ) -> None:
        self.moodle.post(
    ...
    def save_submission(
        self, assignmentid: int, plugindata: PluginData
    ) -> List[Warning]:
        res = self.moodle.post(
    ...
    def save_user_extensions(
        self, assignmentid: int, userids: List[int], dates: List[Union[datetime, int]]
    ) -> List[Warning]:
        res = self.moodle.post(
    ...
    def set_user_flags(
        self, assignmentid: int, userflags: List[UserFlag]
    ) -> List[UserFlag.Result]:
        res = self.moodle.post(
            "mod_assign_set_user_flags", assignmentid=assignmentid, userflags=userflags
        )
        return self._trs(UserFlag.Result, res)

    def submit_for_grading(
        self, assignmentid: int, acceptsubmissionstatement: int
    ) -> List[Warning]:
    ...
    def submit_grading_form(
        self, assignmentid: int, userid: int, jsonformdata: str
    ) -> List[Warning]:
    ...
    def unlock_submissions(self, assignmentid: int, userids: int) -> List[Warning]:
